...
void solve(int tt) {
    ...
    fr(i,0,n) {
        int l,r,riyal;cin >> l >> r >> riyal;

        casinos.push_back(vi{l,r,riyal});
    }

    sort(casinos.begin(), casinos.end(),[](vi a,vi b) {
        return a[0] < b[0];
    });
    ...
    while (ptr<n) {
        ...
        int l = casinos[ptr][0], r = casinos[ptr][1], c = casinos[ptr][2];
