//
// Created by bravefart69 on 17/11/24.
//
#include <bits/stdc++.h>
#include <climits>
#include <fstream>
...
void solve(int tt) {
    ...
    // dp[i][k] = dp[i+1][k] + dp[i][k-coin_i] -> 2 loops needed one for each dimension
    // for i-> going from last to first and for k from start to last
